...
#include <cstdint>
constexpr inline uint32_t SCREEN_WIDTH = 800;
constexpr inline uint32_t SCREEN_HEIGHT = 600;

constexpr inline uint32_t TILE_SIZE = 10;
...
constexpr inline uint32_t REPRODUCTION_FOOD_FACTOR = 8;
...
constexpr inline float ROTATION_CHANCE = 0.08;
constexpr inline uint32_t MAX_SPAWN_ATTEMPTS = 5;
